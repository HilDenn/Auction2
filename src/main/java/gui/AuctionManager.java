...
public class AuctionManager {
    ...
    public static void buyItem(Player player, InventoryClickEvent event){
        ...
        GuiManager.removeItems(event.getClickedInventory(), event.getCurrentItem(), item.getAmount());
